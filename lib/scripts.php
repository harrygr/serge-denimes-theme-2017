...
function roots_scripts() {
  ...
  // Twitter Remarketing  
  wp_register_script( 'twitter-remarketing','//platform.twitter.com/oct.js', array(), false, true );
  wp_enqueue_script( 'twitter-remarketing' );
  ...
  wp_register_script('chosen', get_template_directory_uri() . '/assets/js/chosen/chosen.jquery.min.js', array('jquery'), '0fc6af96786d8f267c8686338a34cd38', true);
